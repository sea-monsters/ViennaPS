...
function(viennaps_prepare_vtk)
  if(TARGET VTK::CommonCore)
    ...
    set(_VIENNAPS_LOCAL_VTK_SOURCE "")
    if(VIENNAPS_VTK_SOURCE_DIR)
      get_filename_component(_VIENNAPS_LOCAL_VTK_SOURCE
                             "${VIENNAPS_VTK_SOURCE_DIR}" ABSOLUTE)
      if(NOT EXISTS "${_VIENNAPS_LOCAL_VTK_SOURCE}/CMakeLists.txt")
        message(
          FATAL_ERROR
            "[ViennaPS] VIENNAPS_VTK_SOURCE_DIR does not contain CMakeLists.txt: "
            "${_VIENNAPS_LOCAL_VTK_SOURCE}")
      endif()
    endif()

    if(NOT _VIENNAPS_LOCAL_VTK_SOURCE AND NOT VIENNAPS_PACKAGE_PYTHON)
      find_package(VTK 9.0.0 QUIET)
    endif()

    if(_VIENNAPS_LOCAL_VTK_SOURCE)
      message(STATUS "[ViennaPS] Using local VTK source: ${_VIENNAPS_LOCAL_VTK_SOURCE}")
      ...
      set(VTK_SOURCE_DIR "${_VIENNAPS_LOCAL_VTK_SOURCE}")
      set(VTK_BINARY_DIR "${CMAKE_BINARY_DIR}/_deps/vtk-build")
    ...
    unset(_VIENNAPS_LOCAL_VTK_SOURCE)
  endif()
