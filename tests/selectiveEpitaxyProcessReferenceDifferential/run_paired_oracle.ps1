...
& (Join-Path $PSScriptRoot '..\common\run_reference_oracle.ps1') `
  ...
  -FixtureSource 'selective_epitaxy_process_cpu_fixture.cpp' `
  -CheckerSource 'selective_epitaxy_process_cpu_checker.cpp' `
  -ModDefine '/DVIENNAPS_SELECTIVE_EPITAXY_PROCESS_ORACLE_MOD' `
