// SEH/DbgHelp capture wrapper for the P5-N1E/N1F real-tree query probe.
// Mirrors neutral_cpu_oracle_crash_capture.cpp: includes the unchanged probe
// translation unit, renames its main, and records the exception code,
// instruction address, registers, and symbolized stack. Test-only; it changes
// no probe, production, reference, flag, or fixture semantics.

#define main neutral_cpu_oracle_kdtree_probe_main
#include "neutral_cpu_oracle_kdtree_probe.cpp"
#undef main
...
int main(int argc, char **argv) {
  __try {
    return neutral_cpu_oracle_kdtree_probe_main(argc, argv);
